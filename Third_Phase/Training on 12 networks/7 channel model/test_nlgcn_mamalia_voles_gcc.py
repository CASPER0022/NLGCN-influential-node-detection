...
def load_graph(path):
    ...
    print(f"Extracted GCC: Nodes = {G_gcc.number_of_nodes()}, Edges = {G_gcc.number_of_edges()} (Original: Nodes = {G.number_of_nodes()}, Edges = {G.number_of_edges()})")
    return G_gcc
...
def main():
    ...
    print("Loading Mammalia Voles graph (GCC) and calculating features...")
    ...
    # Display results
    print("\n" + "="*70)
    print("  MAMMALIA VOLES (GCC ONLY) MODEL PERFORMANCE EVALUATION")
    print("="*70)

...
dataset_path = os.path.abspath(os.path.join(script_dir, "..", "..", "Datasets", "Test", "karate.txt"))
...
def main():
    ...
    # Display results
    print("\n" + "="*95)
    print("  6-CHANNEL LCC MODEL PERFORMANCE EVALUATION (KARATE CLUB)")
    print("="*95)
    ...
    # Limit top list to min(15, n) in case graph is small (like karate which has N=34)
    top_k = min(15, n)

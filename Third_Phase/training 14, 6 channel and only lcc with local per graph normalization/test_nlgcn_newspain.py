...
dataset_path = os.path.abspath(os.path.join(script_dir, "..", "..", "Datasets", "Test", "NewSpain_18c_travelmap.txt"))
...
def main():
    ...
    # Display results
    print("\n" + "="*95)
    print("  6-CHANNEL LCC MODEL PERFORMANCE EVALUATION (NEW SPAIN 18c TRAVEL MAP - LOCAL NORM)")
    print("="*95)

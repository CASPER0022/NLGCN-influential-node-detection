...
def main():
    ...
    print("Loading Multi-Scale WNLGCN model...")
    model = MSWNLGCN()
    ...
    pdf_report_path = os.path.join(script_dir, "analysis_report_6channel_multiscale.pdf")
    ...
    with PdfPages(pdf_report_path) as pdf:
        # Page 1: Explanation
        intro_title = "Evaluation Report: WNLGCN (Multi-Scale 6-Channel) Performance Analysis"
        intro_paragraphs = [
            "### 1. Introduction and Objectives",
            "This report evaluates the performance of the Multi-Scale 6-Channel WNLGCN model (wnlgcn_6ch_multiscale.pth) on scale-free datasets.",
            "By implementing parallel convolution receptive fields (kernel sizes 2, 3, and 4), the model captures topological structures at multiple structural scopes simultaneously.",
            "",
        ...
        benefits_text = "The Multi-Scale convolutional representation successfully captures both local densities and multi-hop paths, yielding consistent improvements over classical centrality metrics. Best performer is highlighted in light blue, and test datasets are in light green."

        headers = ["Network Dataset", "Ours (MS-WNLGCN)", "W-Eigenvector", "Strength (W-Deg)", "W-Closeness", "W-Betweenness"]

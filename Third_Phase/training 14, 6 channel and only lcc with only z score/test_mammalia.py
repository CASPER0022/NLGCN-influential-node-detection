...
# Define target Mammalia network
mammalia_network = {
    "name": "Mammalia Voles",
    "file": os.path.join(datasets_dir, "Test", "mammalia-voles-bhp-trapping.edges")
}
...
def main():
    ...
    name = mammalia_network["name"]
    filepath = mammalia_network["file"]
    ...
    r10 = get_kendall(pred, labels, 10, nodelist, deg_cent_vals, clos_cent_val, bet_cent_vals, pr_cent_vals, core_cent_vals, eig_cent_vals, has_eig)
    r20 = get_kendall(pred, labels, 20, nodelist, deg_cent_vals, clos_cent_val, bet_cent_vals, pr_cent_vals, core_cent_vals, eig_cent_vals, has_eig)
    r100 = get_kendall(pred, labels, 100, nodelist, deg_cent_vals, clos_cent_val, bet_cent_vals, pr_cent_vals, core_cent_vals, eig_cent_vals, has_eig)

    # Output markdown table
    print(f"\n### Mammalia Voles Results Table (Scale-Free GNN Model)")
